import{f as n,b,u as y,j as e,P as re,Q as P,a as v,e as h,R as se,T as oe,U as ae,V as Z,W as ee,X as ce,s as D,L as le,C as I,Y as de}from"./index-f020bdc2.js";import{n as B}from"./emotion-styled.browser.esm-879d5059.js";import{c as pe}from"./emotion-react.browser.esm-e016b5a5.js";import{P as xe}from"./PageAnimatedWrapper-fe285310.js";import{B as he}from"./Button-ae7cb4c8.js";import{g as ue}from"./productsHelpers-95529711.js";const ge=n.ul`
  display: flex;
  gap: 28px;
  margin-bottom: 48px;
...
`,_e=n.span`
  color: #efede8;
`,S={cardLabel:"Workout",btnLabel:"Start",list:{burnedCalories:"Burned calories:",bodyPart:"Body parts:",target:"Target:"}},G=t=>t.slice(0,1).toUpperCase()+t.slice(1),Ge=({data:t})=>{const i=y(),r=()=>{i(Z(!0)),i(ee(t))};return e.jsxs($e,{children:[e.jsxs(Be,{children:[e.jsx(Me,{children:S.cardLabel}),e.jsxs(We,{type:"button",onClick:r,children:[S.btnLabel,e.jsx(Fe,{children:e.jsx("use",{href:`${v}#icon-arrow-start`})})]})]}),e.jsxs(De,{children:[e.jsx(Ue,{children:e.jsx(qe,{width:24,height:24,children:e.jsx("use",{href:`${v}#icon-running`})})}),e.jsxs(Ne,{children:[G(t.name)," "]})]}),e.jsx(Ae,{children:Object.keys(S.list).map(s=>e.jsxs(Oe,{children:[S.list[s],e.jsx(_e,{children:G(String(t[s]))})]},s))})]})},Ve=n.div`
  display: flex;
`,Xe=n.div`
  display: none;
  @media screen and (min-width: 1440px) {
