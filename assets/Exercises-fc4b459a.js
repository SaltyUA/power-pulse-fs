import{b as u,j as e,a as z,u as P,e as p,F as N,c as E,G as S,H as L}from"./index-898bec7e.js";import{n as h}from"./emotion-styled.browser.esm-f12671d3.js";import{P as B}from"./PageAnimatedWrapper-e1ac0640.js";const q=u.ul`
  display: flex;
  gap: 28px;
  margin-bottom: 48px;
...
`,k=h.h2`
  ...
  line-height: 1.16;
  margin-bottom: 20px;
`,Z=()=>{const[s,o]=p.useState("Body parts"),[c,i]=p.useState(""),a=t=>{i(t)},l=t=>{o(t)},d=t=>t.slice(0,1).toUpperCase()+t.slice(1);return e.jsx(B,{direction:"X",children:e.jsxs(J,{children:[e.jsxs(K,{children:[e.jsx(k,{children:"Exercises"}),e.jsx(k,{children:d(c)}),e.jsx(W,{activeFilter:s,handleFilterClick:l})]}),s==="Body parts"&&e.jsx(G,{handleFilterClick:l,handleSetExName:a}),s==="Muscles"&&e.jsx(H,{handleFilterClick:l,handleSetExName:a}),s==="Equipment"&&e.jsx(X,{handleFilterClick:l,handleSetExName:a})]})})};export{Z as default};
