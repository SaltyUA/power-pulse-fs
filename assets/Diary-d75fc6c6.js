import{j as e,a as d,b as y,u as v,q as E,t as C,w as A,e as b,x as I,y as $,z as F}from"./index-ba0ad5df.js";import{n as i}from"./emotion-styled.browser.esm-9536b4cb.js";import{e as S,P,T as B,N as R}from"./TitlePage.styled-53b10b2f.js";import{c as M,G as L}from"./emotion-react.browser.esm-0e0aad0f.js";import{P as N}from"./PageAnimatedWrapper-9721baf5.js";import"./defineProperty-4681ad55.js";const H=i.div`
  width: 100%;
  margin-inline: auto;
  padding-inline: 20px;
  /* padding-top: 61px; */
...
`,$e=r=>r.diary.diaryInfo,k=r=>r.diary.choiceDate,_e=({calories:r,time:n,exercise:t})=>{const a=y(k),o=v(),f=u=>{o(E({date:a,id:u}))};return e.jsxs(ge,{children:[e.jsxs(me,{children:[e.jsx(s,{children:"Body part"}),e.jsx(g,{children:e.jsx(j,{children:t.bodyPart})})]}),e.jsxs(fe,{children:[e.jsx(s,{children:"Equipment"}),e.jsx(g,{children:e.jsx(j,{children:t.equipment})})]}),e.jsxs(ue,{children:[e.jsx(s,{children:"Name"}),e.jsx(g,{children:e.jsx(j,{children:t.name})})]}),e.jsxs(we,{children:[e.jsx(s,{children:"Target"}),e.jsx(g,{children:e.jsx(j,{children:t.target})})]}),e.jsxs(je,{children:[e.jsx(s,{children:"Burned Calories"}),e.jsx(g,{children:r})]}),e.jsxs(be,{children:[e.jsx(s,{children:"Time"}),e.jsx(g,{children:n})]}),e.jsxs(ye,{children:[e.jsx(s,{}),e.jsx(ve,{onClick:()=>f(t._id),children:e.jsx(ke,{iconColor:"#EF8964",children:e.jsx("use",{href:`${d}#icon-trash`})})})]})]},t._id)},ze=({consumedExercises:r})=>{const n=C(),t=()=>{n("/exercises")};return e.jsxs(J,{children:[e.jsxs(K,{children:[e.jsx(O,{children:"Execrcises"}),e.jsxs(Q,{onClick:()=>t(),children:[e.jsx(Z,{children:"Add exercise"}),e.jsx(ee,{iconColor:"#E6533C",children:e.jsx("use",{href:`${d}#icon-start-arrow`})})]})]}),e.jsx(re,{children:e.jsxs(te,{children:[e.jsx(ne,{children:"Body Part"}),e.jsx(de,{children:"Equipment"}),e.jsx(ae,{children:"Name"}),e.jsx(oe,{children:"Target"}),e.jsx(se,{children:e.jsx(le,{children:"Burned Calories"})}),e.jsx(ce,{children:"Time"}),e.jsx(pe,{})]})}),r&&r.length>0?e.jsx(he,{children:r.map(a=>e.jsx(_e,{...a},T()))}):e.jsx(ie,{children:"Not found exercises"})]})},De=r=>{switch(r.dimentionArea){case"true":return"780px";case"false":return"335px";default:return"335px"}},Ce=i.div`
  position: relative;
  width: 100%;
  border: 1px solid;
  border-color: rgba(239, 237, 232, 0.2);
...
`;const ci=()=>{const r=v(),[n,t]=b.useState(Date.now());b.useEffect(()=>{r(I($(n,"dd-MM-yyyy")))});const a=b.forwardRef(({value:o,onClick:f},u)=>e.jsxs(oi,{onClick:f,ref:u,children:[$(n,"dd/MM/yyyy"),e.jsx(si,{iconColor:"#EF8964",children:e.jsx("use",{href:`${d}#icon-calendar`})})]}));return e.jsxs(e.Fragment,{children:[e.jsx(L,{styles:ai}),e.jsx(S,{selected:n,onChange:o=>{t(o)},customInput:e.jsx(a,{}),dateFormat:"dd MM yyyy",calendarStartDay:1,formatWeekDay:o=>o.substr(0,1),maxDate:Date.now()})]})},pi=()=>e.jsxs(ni,{children:[e.jsx(ci,{}),e.jsxs(di,{children:[e.jsx(D,{type:"button",children:e.jsx(z,{iconColor:"#efede8",children:e.jsx("use",{href:`${d}#icon-left`})})}),e.jsx(D,{type:"button",children:e.jsx(z,{iconColor:"#efede8",children:e.jsx("use",{href:`${d}#icon-right`})})})]})]}),G=({title:r})=>e.jsx(B,{children:r});G.propTypes={title:P.string.isRequired};const li=i.div`
  width: 100%;
  position: relative;
  display: flex;
  flex-direction: column;
