import{g as u,j as e,d as k,e as E,r as p,x as N,u as P,y as S,z as L}from"./index-26215cd7.js";import{n as h}from"./emotion-styled.browser.esm-13f51baa.js";const B=u.ul`
  display: flex;
  gap: 28px;
  margin-bottom: 48px;
...
`,q=({activeFilter:s,handleFilterClick:a})=>e.jsxs(B,{children:[e.jsx(j,{className:s==="Body parts"?"active":"",children:e.jsx(b,{type:"button",onClick:()=>a("Body parts"),className:s==="Body parts"?"active":"",children:"Body parts"})}),e.jsx(j,{className:s==="Muscles"?"active":"",children:e.jsx(b,{type:"button",onClick:()=>a("Muscles"),className:s==="Muscles"?"active":"",children:"Muscles"})}),e.jsx(j,{className:s==="Equipment"?"active":"",children:e.jsx(b,{type:"button",onClick:()=>a("Equipment"),className:s==="Equipment"?"active":"",children:"Equipment"})})]}),y=u.ul`
  display: flex;
  flex-wrap: wrap;
  gap: 20px;
